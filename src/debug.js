...
function debug() {
  ...
  const words = ['nimitzitta', 'niquitta', 'tinechitta', 'tiquitta', 'nechitta', 'mitzitta', 'quitta', 'namechitta', 'niquimitta', 'titechitta', 'tamechitta', 'quittah', 'quimitta', 'quimittah', 'nimitzana', 'nicana', 'nimitztlazohtla', 'nictlazohtla', 'cana', 'quitlazohtla', 'ancanah', 'anquitlazohtlah', 'niquimana', 'niquintlazohtla', 'tiquittah', 'anquicuah', 'quih', 'nitetlazohtla', 'nitlacua', 'niteana', 'nitlacaqui', 'niteitta', 'nitlatta', 'niquihtoa', 'nitlahtoa', 'niquihcuiloa', 'nitlahcuiloa', 'niteitta', 'niteihtoa']; // classical vocabulary, set 3
  //const words = ['tochtli'];
