...
function debug() {
  ...
  //const words = ['nicah', 'ticah', 'cah', 'ticateh', 'ancateh', 'cateh', 'niyauh', 'tiyauh', 'yauh', 'tihuih', 'anhuih', 'huih', 'nihuitz', 'tihuitz', 'huitz', 'tihuitzeh', 'anhuitzeh', 'huitzeh', 'can', 'canin', 'mexihco', 'tlaxcallan', 'ahcan', 'nican', 'oncan', 'ompa', 'nemi', 'cualli', 'cualcan', 'ahci', 'nihcihui', 'niquiza', 'campa', 'tlaxcallampa', 'mexihcopa']; // classical vocabulary, set 5
  const words = ['nihuitoni', 'tihuitoni', 'huitoni', 'tihuitonih', 'inhuitonih', 'huitonih', 'moillia', 'tlacua', 'momachtia', 'motlaloa', 'mococoa', 'na', 'ta', 'ya', 'tohhuantin', 'inmohhuantin', 'inihhuantin', 'yahhuantin', 'tiyaz', 'tehhuatl', 'tehhua', 'teh', 'tehhuatzin', 'momahuizotzin', 'timotlaloah', 'intlacuah', 'nehnemi', 'nehnemih', 'mohmoztla', 'nicochi', 'titlahcuiloa', 'quemmantzin', 'titlahcuiloah', 'timomachtiah', 'etzin', 'atzin', 'conetzin', 'piletzin', 'pilatzin', 'pilconetzin', 'pilchichitzin', 'conetzitzin', 'tlazolli', 'xihuitl', 'zacatl', 'ohtli', 'xalli', 'tlalli', 'zoquitl']; // modern vocabulary, set 4
  //const words = ['motlaloa', 'intlacameh', 'yeh'];
